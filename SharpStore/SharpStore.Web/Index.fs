...
let jumbotron =
    div [ _class "jumbotron" ] [
        div [ _class "container" ] [
            h1 [ _class "fw-bold display-4" ] [ str "Welcome to Our Widget and Gadget Store" ]
            ...
            p [] [
                ...
                str
                    "Our store offers unbeatable deals on a wide range of widgets and gadgets, perfect for businesses, hobbyists, and anyone who needs a lot."
            ]
            p [ _class "lead" ] [
